...
┷┯ 👉 Others Commands 👈
   ...
   ╿
   ╿
   ╰╼❥ Kirim perintah *$desk/desk* untuk mengetahui fungsi dan cara penggunaan perintah di atas, WAJIB BACA!!.`
}
exports.menu = menu()
function desk() {
    return `
...
function info() {
    return `
Owner Bot : wa.me/681572880106
Author? : Cyber Team Index`
}
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *Kingoe Project BoT*
